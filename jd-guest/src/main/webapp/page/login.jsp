...
<head>
    ...
    <script src="${rootPath }/js/checkcode.js"></script>
	<title>登录页面</title>
	<style type="text/css">
		#body{
			background: #e3e0e0;
  	...
  	<div class="w">
  		...
  		<div class="login-form" align="center">
  			...
  			<div class="login-box" style="visibility: visible; display:block">
  			  ...
  			  <div class="mc">
  			  	<div class="form">
  			  		<form action="${rootPath }/userController/loginUser" id="formlogin" method="post" >
  				...
  				<div class="mc">
  					...
  					<div class="qrcode-main">
  						...
  						<div class="qrcode-img" style="">
  							<img src="${rootPath }/images/code.png" alt="">
...
// 	}
	...
	function validate(){
		...
		var password = $("#password").val();
 		var reg = /\w/;
		var testUsername = reg.test(username);
		var testPassword = reg.test(password);
